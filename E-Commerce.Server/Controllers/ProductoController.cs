...
namespace E_Commerce.Server.Controllers
{
    ...
    public class ProductoController(IProductoService productoService) : ControllerBase
    {
        ...
        public async Task<ActionResult> CreateAsync([FromForm] CreateProductoRequestDTO request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> PutAsync([FromForm] UpdateProductoRequestDTO request)
        {
