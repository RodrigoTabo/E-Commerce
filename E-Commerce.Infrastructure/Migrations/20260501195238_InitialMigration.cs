        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carritos_AspNetUsers_IdApplicationUser",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Modelos_TipoProductos_IdTipoProducto",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Productos_AspNetUsers_IdApplicationUser",
                        column: x => x.IdApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Domicilios_AspNetUsers_IdApplicationUser",
                        column: x => x.IdApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Domicilios_Ciudades_IdCiudad",
                        column: x => x.IdCiudad,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favoritos_AspNetUsers_IdApplicationUser",
                        column: x => x.IdApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favoritos_Productos_IdProducto",
                        column: x => x.IdProducto,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reviews_AspNetUsers_IdApplicationUser",
                        column: x => x.IdApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstadoOrden = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ordenes_AspNetUsers_IdApplicationUser",
                        column: x => x.IdApplicationUser,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ordenes_Domicilios_IdDomicilio",
                        column: x => x.IdDomicilio,
                        principalTable: "Domicilios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ordenes_MetodoEnvios_IdMetodoEnvio",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdenItems_MetodoEnvios_MetodoEnvioId",
                        column: x => x.MetodoEnvioId,
                        principalTable: "MetodoEnvios",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrdenItems_Ordenes_IdOrden",
                        column: x => x.IdOrden,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTransaccion = table.Column<int>(type: "int", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carritos_IdApplicationUser",
                table: "Carritos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Domicilios_IdApplicationUser",
                table: "Domicilios",
                column: "IdApplicationUser");

            migrationBuilder.CreateIndex(
                name: "IX_Domicilios_IdCiudad",
                table: "Domicilios",
                column: "IdCiudad");

            migrationBuilder.CreateIndex(
                name: "IX_Favoritos_IdApplicationUser_IdProducto",
                table: "Favoritos",
                columns: new[] { "IdApplicationUser", "IdProducto" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Modelos_IdMarca_Nombre_IdTipoProducto",
                table: "Modelos",
                columns: new[] { "IdMarca", "Nombre", "IdTipoProducto" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Modelos_IdTipoProducto",
                table: "Modelos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ordenes_CreatedAt",
                table: "Ordenes",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_Ordenes_IdApplicationUser",
                table: "Ordenes",
                column: "IdApplicationUser");

            migrationBuilder.CreateIndex(
                name: "IX_Ordenes_IdDomicilio",
                table: "Ordenes",
                column: "IdDomicilio");

            migrationBuilder.CreateIndex(
                name: "IX_Ordenes_IdMetodoEnvio",
                table: "Ordenes",
                column: "IdMetodoEnvio");

            migrationBuilder.CreateIndex(
                name: "IX_OrdenItems_IdOrden",
                table: "OrdenItems",
                column: "IdOrden");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdenItems_MetodoEnvioId",
                table: "OrdenItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Productos_IdApplicationUser",
                table: "Productos",
                column: "IdApplicationUser");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_IdApplicationUser",
                table: "Reviews",
                column: "IdApplicationUser");
